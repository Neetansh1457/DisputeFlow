...
public class DataSeeder {
    ...
    private void seedBanks() {
        ...
        Bank amex = bankRepository.save(Bank.builder()
                ...
                .mockEndpoint("http://mock-banks:8001/amex")
                .isActive(true)
                .maxRetries(3)
        ...
        Bank hsbc = bankRepository.save(Bank.builder()
                ...
                .filePrefix("HSBC")
                .caseIdField("caseNumber")
                .mockEndpoint("http://mock-banks:8001/hsbc")
                .isActive(true)
                .maxRetries(3)
                .retryIntervalMinutes(5)
                .timeoutSeconds(30)
        ...
        Bank pmtc = bankRepository.save(Bank.builder()
                ...
                .mockEndpoint("http://mock-banks:8001/pmtc")
                .isActive(true)
                .maxRetries(3)
                .retryIntervalMinutes(5)
                .timeoutSeconds(30)
        ...
        Bank chase = bankRepository.save(Bank.builder()
                ...
                .filePrefix("CHASE")
                .caseIdField("caseNumber")
                .mockEndpoint("http://mock-banks:8001/chase")
                .isActive(true)
                .maxRetries(3)
                .retryIntervalMinutes(5)
                .timeoutSeconds(30)
